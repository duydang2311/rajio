/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: f538aa964c7ed01d2bb868443e1d20f1)
// Runtime types generated with workerd@1.20260526.1 2026-05-25 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	APP_KV: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	PUBLIC_ROOM_WS_URL: string;
	NUMBER_CODEC_ALPHABET: string;
	SOUNDCLOUD_SCRAPER_API_URL: string;
	AUTH_KEY_PRIVATE: string;
	AUTH_KEY_PUBLIC: string;
	SOUNDCLOUD_SCRAPER: Fetcher /* soundcloud-scraper */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ROOM_WS_URL" | "NUMBER_CODEC_ALPHABET" | "SOUNDCLOUD_SCRAPER_API_URL" | "AUTH_KEY_PRIVATE" | "AUTH_KEY_PUBLIC">> {}
}
